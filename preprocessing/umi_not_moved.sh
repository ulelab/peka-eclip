...
# HepG2-STAU2-1	@K00180 https://www.encodeproject.org/files/ENCFF559ATC/@@download/ENCFF559ATC.bam
...
mv HepG2-EXOSC5-2.* umi_not_moved/
mv HepG2-FTO-1.* umi_not_moved/ 
mv HepG2-STAU2-1.* umi_not_moved/
mv HepG2-STAU2-2.* umi_not_moved/
mv K562-APOBEC3C-1.* umi_not_moved/
mv K562-APOBEC3C-2.* umi_not_moved/
